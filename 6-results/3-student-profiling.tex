...
\input{6-results/tables/tbl-variance-benchmarks}
\input{6-results/tables/tbl-correlation-grades}
\input{6-results/tables/tbl-correlation-events}
...
\input{6-results/figures/fig-correlation-gr12eng}
\input{6-results/figures/fig-correlation-avg}
\input{6-results/figures/fig-correlation-nbtql}
\input{6-results/figures/fig-delta-rank}
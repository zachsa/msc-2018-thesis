    ...
    switch (type) {
        case 'grade':
            ...
            if (typeof percent !== 'number') {
                ...
                var newP = percent.toUpperCase().trim();
                if (disallowedCourseGrades.indexOf(percent) >= 0) return;
                switch (newP) {
                    case 'AB':
                        percent = 40;
                        break;
...
function(head, req) {
    provides('csv', function() {
        ...
        while (row = getRow()) {
            ...
            /* Send previous line if it's a new year; reset year, but not id */
            if (currentYear !== year) {
                sendLine(currentLine);
                currentYear = year;
            };
            ...
            switch (type) {
                ...
                case 'grade':
                    ...
                    currentLine.id = id; // Overwrite benchmark if neccessary

...
\input{5-etl/figures/fig-benchmarks-json-sample}
\input{5-etl/figures/fig-grades-json-sample}
\input{5-etl/figures/fig-events-json-sample}
...
\input{5-etl/figures/fig-netl-logic}
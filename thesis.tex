...
% Title
\title{CouchDB: An example of application in the datamining process}
\author{Zach Smith}
\date{\today}
...
\input{5-analysis/2-benchmark-variance}
\input{5-analysis/3-benchmark-grade-correlation}
\input{5-analysis/4-sakai-rank-correlation}

% Tables
\input{5-analysis/tables/performance-analysis}
\input{5-analysis/tables/tbl-grades-normalize}
\input{5-analysis/tables/tbl-benchmarks-normalize}
...
\input{6-discussion/tables/tbl-correlation-variance}

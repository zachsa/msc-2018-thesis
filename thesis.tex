...
\chapter{Data}
\input{4-data/1-raw-data}
\input{4-data/tables/events}
\input{4-data/tables/grades}
\input{4-data/tables/fu}
\input{4-data/tables/json-entities}

\chapter{ETL}
\input{5-etl/0-overview}
\input{5-etl/1-requirements}
\input{5-etl/2-design}
\input{5-etl/3-configuration}
\input{5-etl/4-couchdb-setup}
\input{5-etl/5-implementation}
